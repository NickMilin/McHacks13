...
export function UploadReceipt() {
  ...
  const processImage = async (file) => {
    ...
    setTimeout(() => {
      const mockExtracted = [
        { id: 1, name: 'Organic Bananas', quantity: 1, unit: 'bunch', category: 'fruit', price: 2.99 },
        { id: 2, name: 'Whole Milk', quantity: 1, unit: 'gallon', category: 'dairy', price: 4.49 },
        { id: 3, name: 'Chicken Thighs', quantity: 2, unit: 'lbs', category: 'protein', price: 8.99 },
        { id: 4, name: 'Baby Spinach', quantity: 1, unit: 'bag', category: 'vegetable', price: 3.99 },
        { id: 5, name: 'Brown Rice', quantity: 2, unit: 'lbs', category: 'grain', price: 4.29 },
        { id: 6, name: 'Greek Yogurt', quantity: 2, unit: 'cups', category: 'dairy', price: 5.98 },
        { id: 7, name: 'Avocados', quantity: 3, unit: 'count', category: 'vegetable', price: 4.47 },
        { id: 8, name: 'Whole Wheat Bread', quantity: 1, unit: 'loaf', category: 'grain', price: 3.99 },
      ]
      setExtractedItems(mockExtracted)
      setSelectedItems(new Set(mockExtracted.map(item => item.id)))
                  ...
                  {isProcessing && (
                    <div className="absolute inset-0 bg-background/80 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Extracting items with OCR</p>
                      </div>
                    </div>
                  )}
                  {/* Remove image button */}
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => setSelectedItems(new Set(extractedItems.map(i => i.id)))}
                  >
                    Select All
                  </Button>
                  <Button
